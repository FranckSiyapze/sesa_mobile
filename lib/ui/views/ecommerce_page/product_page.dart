...
class ProductPage extends StatefulWidget {
  ...
  ProductPage({Key? key, required this.product, required this.heroKey})
      : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  FxText.overline(product.description,
                      color: customAppTheme.colorTextFeed, muted: true),
                  FxSpacing.height(8),
                  product.discountedPrice != product.price
                      ...
                      : FxText.b2(
                          FxTextUtils.doubleToString(product.price) + " FCFA",
                          color: customAppTheme.colorTextFeed,
                          fontWeight: 700),
                ],
              ),
